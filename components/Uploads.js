...
export default class Uploads extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      current_url: 'https://graph.instagram.com/me/media?fields=id,caption&access_token='+props.route.params.params.token+'&limit=10',
      next_url: '',
      previous_url: '',
      posts_data: []
    };
  ...
  renderPost(self, element) {
    return(
      <View>
          <Post post={ element.item } token={ self.state.token } view="list" navigation={ self.props.navigation } route={ self.props.route } props={ self.props } />
      </View>
    )
  }
